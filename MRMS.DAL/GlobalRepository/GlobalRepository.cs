...
namespace MRMS.DAL
{
    public class GlobalRepository : IGlobalRepository, IDisposable
    {
        ...
        private IGenericRepository<ApplicantIssueComment>? _applicantIssueComment;
        ...
        public IGenericRepository<ApplicantIssueComment> ApplicantIssueCommentRepository
        {
            get
            {
                if (_applicantIssueComment == null)
                {
                    _applicantIssueComment = new GenericRepository<ApplicantIssueComment>(_context);
                }
                return _applicantIssueComment;
            }
        }

        public IGenericRepository<ApplicationIssueComment> ApplicationIssueCommentRepository
        {
            get
            {
                if (_applicationIssueCommentRepo == null)
                {
                    _applicationIssueCommentRepo = new GenericRepository<ApplicationIssueComment>(_context);
                }
                return _applicationIssueCommentRepo;
            }
        }

        public IGenericRepository<CallingIssueComment> CallingIssueCommentRepository
        {
            get
            {
                if (_callingIssueCommentRepo == null)
                {
                    _callingIssueCommentRepo = new GenericRepository<CallingIssueComment>(_context);
                }
                return _callingIssueCommentRepo;
            }
        }

        public IGenericRepository<DemandIssueComment> DemandIssueCommentRepository
        {
            get
            {
                if ( _demandIssueCommentRepo  == null)
                {
                    _demandIssueCommentRepo = new GenericRepository<DemandIssueComment>(_context);
                }
                return _demandIssueCommentRepo;
            }
        }

     

        public IGenericRepository<FlightIssueComment> FlightIssueCommentRepository
        {
            get
            {
                if (_flightIssueCommentRepo == null)
                {
                    _flightIssueCommentRepo = new GenericRepository<FlightIssueComment>(_context);
                }
                return _flightIssueCommentRepo;
            }
        }
